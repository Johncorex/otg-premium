...
static constexpr auto STATUS_SERVER_NAME = "OTG-King";
static constexpr auto STATUS_SERVER_VERSION = "1.3";
static constexpr auto STATUS_SERVER_DEVELOPERS = "OTG Team, Johncore, Erick Nunes, Leonardo Pereira, Marson Schneider, Mark Samman, OTXServer (Mattyx Gomez) and The Forgotten Server Developers";
