local setting = {
	...
	storage = Storage.GraveDanger.Tombs.CountVlarkorthTimer,
	bossPosition = {x = 33456, y = 31436, z = 13}, -- posicao boss
	kickPosition = {x = 33195, y = 31690, z = 8}, -- pra onde toma kick
...
function vlarkorthLever.onUse(creature, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 and item.actionid == 57606 then
