local setting = {
	centerRoom = {x = 33425, y = 31473, z = 13}, -- centro sala
	storage = Storage.GraveDanger.Tombs.LordAzaramTimer,
	bossPosition = {x = 33424, y = 31470, z = 13}, -- posicao boss
	kickPosition = {x = 32192, y = 31819, z = 8}, -- pra onde toma kick
	playerTeleport = {x = 33425, y = 31480, z = 13} -- pra onde player vai
}
...
function vlarkorthLever.onUse(creature, item, fromPosition, target, toPosition, isHotkey)
	if item.itemid == 9825 and item.actionid == 57607 then
